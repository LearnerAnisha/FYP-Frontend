...
import {
  ...
  CheckCircle2, ArrowRight, Users, Leaf,
  BarChart3, Shield, Zap, Globe, Quote,
} from "lucide-react";
import {
...
export default function LandingPage() {
  ...
  const features = [
    { icon: Scan,         title: "Crop Disease Detection",   description: "Upload crop images and get instant AI-powered disease identification with treatment recommendations.", color: "text-primary"  },
    { icon: CloudRain,    title: "Weather & Irrigation Tips", description: "Receive personalized irrigation and fertilization advice based on real-time weather and crop data.",  color: "text-chart-4"  },
    { icon: TrendingUp,   title: "Price Predictions",         description: "Access real-time market prices and AI forecasts to make informed selling decisions.",                  color: "text-accent"   },
    { icon: MessageSquare,title: "AI Chatbot Assistant",      description: "Ask questions in natural language and get personalized agricultural guidance instantly.",               color: "text-chart-5"  },
  ];
  ...
  const howItWorks = [
    ...
    { step: "02", title: "Input Data",   description: "Upload crop images or enter your farm details"          },
    { step: "03", title: "Get Insights", description: "Receive AI-powered recommendations instantly"           },
    { step: "04", title: "Take Action",  description: "Implement suggestions and track results"                },
  ];

  const testimonials = [
    { name: "Ram Bahadur Thapa",   location: "Chitwan",   text: "Krishi Saathi helped me detect rice blast disease early. I saved 40% of my crop!",              rating: 5 },
    { name: "Sita Kumari Sharma",  location: "Kaski",     text: "The irrigation tips reduced my water usage by 30% while improving yield. Amazing!",              rating: 5 },
    { name: "Hari Prasad Gautam",  location: "Rupandehi", text: "Price predictions helped me sell at the right time. Increased my income by 25%.",               rating: 5 },
  ];

  const faqs = [
    { question: "What is Krishi Saathi?",                  answer: "Krishi Saathi is an AI-powered agricultural assistant designed for Nepalese farmers. It provides crop disease detection, weather-based irrigation advice, market price predictions, and a conversational AI chatbot for agricultural guidance." },
    { question: "How accurate is the disease detection?",  answer: "Our CNN-based model has been trained on thousands of crop images and achieves high accuracy in detecting common crop diseases. However, we always recommend consulting with agricultural experts for critical decisions." },
    { question: "Is the service free?",                    answer: "We offer a free tier with basic features. Premium features like advanced analytics and unlimited predictions are available through our subscription plans." },
    { question: "What crops are supported?",               answer: "Currently, we support major crops grown in Nepal including rice, wheat, maize, lentils, and various vegetables. We're continuously adding more crops to our database." },
    { question: "Do I need internet to use the app?",      answer: "Yes, an internet connection is required to access real-time weather data, market prices, and AI predictions. We're working on offline capabilities for basic features." },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 sm:space-y-8 animate-fade-in">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                Detect crop diseases instantly, optimize irrigation with weather insights, predict market prices,
                and get 24/7 AI guidance—all in one platform designed for Nepalese farmers.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {features.map((f, i) => {
              const Icon = f.icon;
              return (
                <Card key={i} className="group hover:shadow-elegant transition-smooth border-border hover:border-primary/50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {testimonials.map((t, i) => (
              <Card key={i} className="hover:shadow-elegant transition-smooth">
