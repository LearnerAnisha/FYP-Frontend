...
import {
  Sprout, Menu, X,
  LayoutDashboard, Scan, CloudRain, TrendingUp,
  MessageSquare, LogOut, User, Moon, Sun,
} from "lucide-react";
  ...
  const SidebarContent = ({ isMobile = false }) => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-border flex items-center justify-between">
        {(!collapsed || isMobile) && (
          <Link to="/dashboard" onClick={() => isMobile && setIsOpen(false)} className="flex items-center gap-2 min-w-0">
